...
function TopicCard({ topic, onDateChange, onClearDate, onEdit, onDelete, dateInputs, editingId, editTitle, setEditTitle, setEditingId, handleSaveTitle, today, deleting }) {
  return (
    <motion.div
