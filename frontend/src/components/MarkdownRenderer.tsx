...
const ProgressiveMarkdown = memo(function ProgressiveMarkdown({ chunks }: { chunks: any[] }) {
...
export default memo(MarkdownRenderer, (prev, next) => prev.content === next.content && prev.className === next.className)
